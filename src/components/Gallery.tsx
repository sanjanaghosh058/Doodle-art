...
const saleArtworks = doodleArtworks.map((item) => ({ ...item, salePrice: 249 }))
...
export default function Gallery() {
  ...
  const handleAddToCart = (artwork: typeof saleArtworks[0]) => {
    // Pass a payload that matches the store's expected shape (omit unknown props like salePrice)
    addItem({
      id: artwork.id,
      title: artwork.title,
      ...
      <div className="container mx-auto">
          ...
          {filteredArtworks.map((artwork, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 text-sm">{artwork.description}</p>
        ...
        {filteredArtworks.length === 0 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">No artworks found</h3>
